<template>
	<svelte:head>
		<title>Add Blog - NameSpace IT</title>
			...
			<div class="md:grid md:grid-cols-3 md:gap-6 pr-20 pl-10 pb-20 pt-10">
				<div class="md:col-span-1">
					<div class="px-4 sm:px-0">
						<h3 class="text-lg font-medium leading-6 text-gray-900">Create a New Blog</h3>
						<p class="mt-1 text-sm text-gray-600">Fill the form to create a new blog.</p>
					</div>
				</div>
